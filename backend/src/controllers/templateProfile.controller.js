...
export const getActiveProfile = async (req, res) => {
  try {
    ...
    return serverError(res, 'Failed to retrieve template profile');
  }
};
...
export const listVersions = async (req, res) => {
  try {
    ...
    return serverError(res, 'Failed to list template versions');
  }
};
...
export const createProfile = async (req, res) => {
  try {
    ...
    return serverError(res, 'Failed to create template profile');
  }
};
...
export const updateProfile = async (req, res) => {
  try {
    ...
    return serverError(res, 'Failed to update template profile');
  }
};
...
export const activateProfile = async (req, res) => {
  try {
    ...
    return serverError(res, 'Failed to activate template profile');
  }
};
...
export const rollback = async (req, res) => {
  try {
    ...
    return serverError(res, 'Failed to rollback template profile');
  }
};
...
export const deprecateProfile = async (req, res) => {
  try {
    ...
    return serverError(res, 'Failed to deprecate template profile');
  }
};
...
export const removeProfile = async (req, res) => {
  try {
    ...
    return serverError(res, 'Failed to delete template profile');
  }
};
