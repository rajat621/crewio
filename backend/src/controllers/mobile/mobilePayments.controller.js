...
export const getSalaryHistory = async (req, res) => {
  try {
    ...
    return serverError(res, 'Failed to fetch salary history');
  }
};
...
export const getNetPaymentHistory = async (req, res) => {
  try {
    ...
    return serverError(res, 'Failed to fetch net payment history');
  }
};
...
export const getAdvanceHistory = async (req, res) => {
  try {
    ...
    return serverError(res, 'Failed to fetch advance history');
  }
};
...
export const getDeductionHistory = async (req, res) => {
  try {
    ...
    return serverError(res, 'Failed to fetch deduction history');
  }
};
...
export const getMyExpenseSummary = async (req, res) => {
  try {
    ...
    const deduction = history.filter((r) => r.isDeduction).reduce((sum, r) => sum + r.amount, 0);
    const remainingAmount = Math.max(0, totalAdvance - deduction);
    ...
    return serverError(res, 'Failed to fetch expense summary');
  }
};
