...
process.on('unhandledRejection', (reason) => {
  ...
  // Same treatment as uncaughtException below - once a handler is
  // registered, Node no longer auto-terminates on an unhandled
  // rejection, so without this the process could keep serving requests
  // indefinitely in a potentially corrupted state.
