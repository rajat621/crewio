...
export default function OnboardingAuthorizedSignature() {
  ...
  // Blob URL for the "Preview" button - same reasoning as the company
  // template page: confirm the right file was picked before it's uploaded.
  useEffect(() => {
    if (!signature) {
            ...
            <div className="template-preview-container">
              ...
              <div style={{ display: "flex", gap: "8px" }}>
                <button
                  ...
                  onClick={() => signaturePreviewUrl && window.open(signaturePreviewUrl, "_blank", "noopener")}
                >
                  Preview
                </button>
                <button
