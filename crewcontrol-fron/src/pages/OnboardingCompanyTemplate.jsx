...
export default function OnboardingCompanyTemplate() {
  ...
  // the right file by opening it in a new tab before it's ever uploaded to
  // the server. Revoked whenever the file changes or this page unmounts.
  useEffect(() => {
    if (!template) {
          ...
          {templatePreview ? (
            <div className="template-preview-container">
              ...
              <div style={{ display: "flex", gap: "8px" }}>
                <button
                  type="button"
                  className="onboarding-browse-btn"
                  onClick={() => templatePreviewUrl && window.open(templatePreviewUrl, "_blank", "noopener")}
                >
                  Preview
                </button>
                <button
