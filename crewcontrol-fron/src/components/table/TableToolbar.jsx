...
export default function TableToolbar({
  ...
  onNext,
  pagination = true,
  // Optional month filter, rendered in the same row as pagination (right
  // side, before the prev/next arrows) - same position and component the
  // Attendance table uses. Omit onMonthChange to leave it out entirely.
  monthValue,
  onMonthChange,
  rootSx,
  searchSx,
  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: "flex", alignItems: "center", gap: 1.25 }}>
        {onMonthChange && <MonthFilterSelect value={monthValue} onChange={onMonthChange} allowAll />}
