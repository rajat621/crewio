...
class NormalizedInvoice:
    ...
    original_vat: float = 0.0
    original_net_total: float = 0.0
    original_gross_total: float = 0.0

    financial_corrections: List[str] = field(default_factory=list)
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "original_subtotal": round(self.original_subtotal, 2),
            "original_deductions": round(self.original_deductions, 2),
            "original_vat": round(self.original_vat, 4),
            "original_net_total": round(self.original_net_total, 2),
            "original_gross_total": round(self.original_gross_total, 2),
            ...
            "financial_corrections": self.financial_corrections,
