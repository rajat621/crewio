        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Description - explains the specific, legitimate business
              // purpose BEFORE the OS permission dialog appears, and makes
              // clear this is foreground-only and tied to work sessions,
              // not continuous background tracking.
              Text(
                'CrewControl uses your location only while you\'re checking in '
                'or out, to verify you\'re on-site for attendance. We don\'t '
                'track your location in the background or outside of an '
                'active work session.',
