...
class _ViewAdvancePageState extends State<ViewAdvancePage> with ScreenshotProtection {
  final _attendanceService = ServiceLocator().attendanceService;
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Text(
                Formatters.formatAed(_summary.totalAdvance),
                style: TextStyle(
                  color: const Color(0xFF141414),
                  fontSize: f(16),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    Formatters.formatAed(line.value),
                    style: TextStyle(
                      color: const Color(0xFF141414),
                      fontSize: f(13),
                      fontWeight: FontWeight.w600,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: h(8)),
                Text(
                  Formatters.formatAed(entry.amount),
                  style: TextStyle(
                    color: accent,
                    fontSize: f(20),
                    fontWeight: FontWeight.w600,
